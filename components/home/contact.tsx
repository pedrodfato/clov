...
export default function Contact() {
  return (
    <section id="contato" className="w-full bg-surface">
      ...
      <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-6 pt-32 pb-24 text-center sm:px-10">
        ...
        <div className="relative z-10 flex max-w-[760px] flex-col items-center gap-6">
